...
--%>
                <div class="row"><div class="col-sm-12"><form class="user" method="post" action="/user/add">
...
<%--                  </div>--%>
                  <div class="form-group">
                    Name: <input type="text" class="form-control form-control-user" name="userName" placeholder="Name">
                  </div>
                  <div class="form-group">
                    Email: <input type="email" class="form-control form-control-user" name="userEmail" placeholder="Email Address">
                  </div>
                  <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
